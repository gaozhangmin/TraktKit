...
public extension TraktManager {
     ...
     */
    @discardableResult
    func getSettings(completion: @escaping ObjectCompletionHandler<AccountSettings>) -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func getFollowRequests(completion: @escaping ObjectsCompletionHandler<FollowRequest>) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/requests",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func approveFollowRequest(
        requestID id: NSNumber,
        completion: @escaping ObjectCompletionHandler<FollowResult>
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/requests/\(id)",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .POST
        ) else { return nil }
     ...
     */
    @discardableResult
    func denyFollowRequest(requestID id: NSNumber, completion: @escaping SuccessCompletionHandler) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/requests/\(id)",
            withQuery: [:],
            isAuthorized: true,
    ...
    func hiddenItems(
        section: SectionType,
        type: HiddenItemsType? = nil,
        extended: [ExtendedType] = [.Min],
        pagination: Pagination? = nil,
        completion: @escaping HiddenItemsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        ...
        guard let request = mutableRequest(
            forPath: "users/hidden/\(section.rawValue)",
            withQuery: query,
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func hide(
        ...
        shows: [SyncId]? = nil,
        seasons: [SyncId]? = nil,
        from section: SectionType,
        completion: @escaping ObjectCompletionHandler<HideItemResult>
    ...
    func unhide(
        ...
        seasons: [SyncId]? = nil,
        from section: SectionType,
        completion: @escaping ObjectCompletionHandler<UnhideItemResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons)
    ...
    /**
      ...
      */
    @discardableResult
    func getLikes(type: LikeType, completion: @escaping ObjectsCompletionHandler<Like>) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/likes/\(type.rawValue)",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func getUserProfile(
        username: String = "me",
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectCompletionHandler<User>
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)",
    ...
    func getUserCollection(
        username: String = "me",
        type: MediaType,
        completion: @escaping ObjectsCompletionHandler<TraktCollectedItem>
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/collection/\(type.rawValue)",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func getUserComments(
        ...
        type: Type2? = nil,
        pagination: Pagination? = nil,
        completion: @escaping UserCommentsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
     ...
     */
    @discardableResult
    func getCustomLists(username: String = "me", completion: @escaping ListsCompletionHandler) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/lists",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func createCustomList(
        ...
        completion: @escaping ListCompletionHandler
    ) throws -> URLSessionDataTaskProtocol? {
        ...
        // Request
        guard var request = mutableRequest(forPath: "users/me/lists", withQuery: [:], isAuthorized: true, withHTTPMethod: .POST)
        else { return nil }
     ...
     */
    @discardableResult
    func getCustomList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        completion: @escaping ObjectCompletionHandler<TraktList>
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/lists/\(listID)",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func updateCustomList<T: CustomStringConvertible>(
        listID: T,
        listName: String? = nil,
        ...
        // Request
        guard var request = mutableRequest(forPath: "users/me/lists/\(listID)", withQuery: [:], isAuthorized: true, withHTTPMethod: .PUT)
        else { return nil }
        request.httpBody = try JSONSerialization.data(withJSONObject: json, options: [])
     ...
     */
    @discardableResult
    func deleteCustomList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
     ...
     */
    @discardableResult
    func likeList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        completion: @escaping SuccessCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/\(username)/lists/\(listID)/like",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .POST
        ) else { return nil }
     ...
     */
    @discardableResult
    func removeListLike<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        completion: @escaping SuccessCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func getItemsForCustomList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        type: [ListItemType]? = nil,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ListItemCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
     ...
     */
    @discardableResult
    func addItemToCustomList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        movies: [SyncId]? = nil,
        shows: [SyncId]? = nil,
        ...
        episodes: [SyncId]? = nil,
        people: [SyncId]? = nil,
        completion: @escaping AddListItemCompletion
    ) throws -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func removeItemFromCustomList<T: CustomStringConvertible>(
        username: String = "me",
        listID: T,
        movies: [SyncId]? = nil,
        shows: [SyncId]? = nil,
        ...
        episodes: [SyncId]? = nil,
        people: [SyncId]? = nil,
        completion: @escaping RemoveListItemCompletion
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes, people: people)
     ...
     */
    @discardableResult
    func getUserAllListComments(
        username: String = "me",
        listID: String,
        completion: @escaping CommentsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/\(username)/lists/\(listID)/comments",
            withQuery: [:],
            isAuthorized: false,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func followUser(username: String, completion: @escaping FollowUserCompletion) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/\(username)/follow",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .POST
        ) else { return nil }
     ...
     */
    @discardableResult
    func unfollowUser(username: String, completion: @escaping SuccessCompletionHandler) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "users/\(username)/follow",
            withQuery: [:],
            isAuthorized: true,
     ...
     */
    @discardableResult
    func getUserFollowers(username: String = "me", completion: @escaping FollowersCompletion) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/followers",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func getUserFollowing(username: String = "me", completion: @escaping FollowersCompletion) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/following",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func getUserFriends(username: String = "me", completion: @escaping FriendsCompletion) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/friends",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func getUserWatchedHistory(
        username: String = "me",
        type: WatchedType? = nil,
        traktId: Int? = nil,
        startAt: Date? = nil,
        endAt: Date? = nil,
        extended: [ExtendedType] = [.Min],
        pagination: Pagination? = nil,
        completion: @escaping HistoryCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
    ...
    func getUserRatings(
        ...
        type: MediaType? = nil,
        rating: NSNumber? = nil,
        completion: @escaping RatingsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
    ...
    func getUserWatchlist(
        ...
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/watchlist/\(type.rawValue)",
            withQuery: ["extended": extended.queryString()],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func getUserWatching(username: String = "me", completion: @escaping WatchingCompletion) -> URLSessionDataTaskProtocol? {
        ...
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/watching",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func getUserWatched(
        ...
        type: MediaType,
        extended: [ExtendedType] = [.Min],
        completion: @escaping UserWatchedCompletion
    ) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard var request = mutableRequest(
            forPath: "users/\(username)/watched/\(type.rawValue)",
            withQuery: ["extended": extended.queryString()],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func getUserStats(username: String = "me", completion: @escaping UserStatsCompletion) -> URLSessionDataTaskProtocol? {
        let authorization = username == "me" ? true : false
        guard let request = mutableRequest(
            forPath: "users/\(username)/stats",
            withQuery: [:],
            isAuthorized: authorization,
            withHTTPMethod: .GET
        ) else { return nil }
