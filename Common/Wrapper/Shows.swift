...
public extension TraktManager {
    ...
    func getTrendingShows(
        ...
        filters: [Filter]? = nil,
        completion: @escaping TrendingShowsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getTrending(.Shows, pagination: pagination, extended: extended, filters: filters, completion: completion)
    }
    ...
    func getPopularShows(
        ...
        extended: [ExtendedType] = [.Min],
        filters: [Filter]? = nil,
        completion: @escaping paginatedCompletionHandler<TraktShow>
    ) -> URLSessionDataTaskProtocol? {
        getPopular(.Shows, pagination: pagination, extended: extended, filters: filters, completion: completion)
    }
    ...
    func getPlayedShows(
        ...
        pagination: Pagination? = nil,
        completion: @escaping MostShowsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getPlayed(.Shows, period: period, pagination: pagination, completion: completion)
    }
    ...
    func getWatchedShows(
        ...
        getWatched(.Shows, period: period, pagination: pagination, completion: completion)
    }
     ...
     */
    @discardableResult
    func getCollectedShows(
        period: Period = .Weekly,
        pagination: Pagination? = nil,
        completion: @escaping MostShowsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getCollected(.Shows, pagination: pagination, completion: completion)
    }
     ...
     */
    @discardableResult
    func getAnticipatedShows(
        period: Period = .Weekly,
        pagination: Pagination? = nil,
        extended: [ExtendedType] = [.Min],
        completion: @escaping AnticipatedShowCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getAnticipated(.Shows, pagination: pagination, extended: extended, completion: completion)
    }
     ...
     */
    @discardableResult
    func getUpdatedShows(
        startDate: Date?,
        pagination: Pagination? = nil,
        extended: [ExtendedType] = [.Min],
        completion: @escaping paginatedCompletionHandler<Update>
    ) -> URLSessionDataTaskProtocol? {
        getUpdated(.Shows, startDate: startDate, pagination: pagination, extended: extended, completion: completion)
    }
     ...
     */
    @discardableResult
    func getUpdatedShowTraktIds(
        from startDate: Date,
        pagination: Pagination? = nil,
        completion: @escaping paginatedCompletionHandler<Int>
    ) -> URLSessionDataTaskProtocol? {
        ...
        let path =
            "shows/updates/id/\(startDate.dateString(withFormat: "yyyy-MM-dd'T'HH:mm:ss").addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? startDate.dateString(withFormat: "yyyy-MM-dd"))"
     ...
     */
    @discardableResult
    func getShowSummary<T: CustomStringConvertible>(
        showID id: T,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectCompletionHandler<TraktShow>
    ) -> URLSessionDataTaskProtocol? {
        getSummary(.Shows, id: id, extended: extended, completion: completion)
    }
     ...
     */
    @discardableResult
    func getShowAliases<T: CustomStringConvertible>(
        showID id: T,
        completion: @escaping ObjectsCompletionHandler<Alias>
    ) -> URLSessionDataTaskProtocol? {
        getAliases(.Shows, id: id, completion: completion)
    }
    ...
    /**
      ...
      */
    @discardableResult
    func getShowTranslations<T: CustomStringConvertible>(
        showID id: T,
        language: String?,
        completion: @escaping ShowTranslationsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getTranslations(.Shows, id: id, language: language, completion: completion)
    }
     ...
     */
    @discardableResult
    func getShowComments<T: CustomStringConvertible>(
        showID id: T,
        pagination: Pagination? = nil,
        completion: @escaping CommentsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getComments(.Shows, id: id, pagination: pagination, completion: completion)
    }
     ...
     */
    @discardableResult
    func getListsContainingShow<T: CustomStringConvertible>(
        showID id: T,
     ...
     */
    @discardableResult
    func getShowCollectionProgress<T: CustomStringConvertible>(
        showID id: T,
        hidden: Bool = false,
        specials: Bool = false,
        completion: @escaping ObjectCompletionHandler<ShowCollectionProgress>
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "shows/\(id)/progress/collection",
            withQuery: [
                "hidden": "\(hidden)",
                "specials": "\(specials)",
            ],
     ...
     */
    @discardableResult
    func getShowWatchedProgress<T: CustomStringConvertible>(
        showID id: T,
        hidden: Bool = false,
        specials: Bool = false,
        completion: @escaping ShowWatchedProgressCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "shows/\(id)/progress/watched",
            withQuery: [
                "hidden": "\(hidden)",
                "specials": "\(specials)",
            ],
     ...
     */
    @discardableResult
    func getPeopleInShow<T: CustomStringConvertible>(
        showID id: T,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectCompletionHandler<CastAndCrew<TVCastMember, TVCrewMember>>
    ) -> URLSessionDataTaskProtocol? {
        getPeople(.Shows, id: id, extended: extended, completion: completion)
    }
     ...
     */
    @discardableResult
    func getShowRatings<T: CustomStringConvertible>(
        showID id: T,
        completion: @escaping RatingDistributionCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getRatings(.Shows, id: id, completion: completion)
    }
     ...
     */
    @discardableResult
    func getRelatedShows<T: CustomStringConvertible>(
        showID id: T,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectsCompletionHandler<TraktShow>
    ) -> URLSessionDataTaskProtocol? {
        getRelated(.Shows, id: id, extended: extended, completion: completion)
    }
     ...
     */
    @discardableResult
    func getShowStatistics<T: CustomStringConvertible>(
        showID id: T,
        completion: @escaping statsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        getStatistics(.Shows, id: id, completion: completion)
    }
     ...
     */
    @discardableResult
    func getUsersWatchingShow<T: CustomStringConvertible>(
        showID id: T,
        completion: @escaping ObjectsCompletionHandler<User>
    ) -> URLSessionDataTaskProtocol? {
        getUsersWatching(.Shows, id: id, completion: completion)
    }
     ...
     */
    @discardableResult
    func getNextEpisode<T: CustomStringConvertible>(
        showID id: T,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectCompletionHandler<TraktEpisode>
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "shows/\(id)/next_episode",
     ...
     */
    @discardableResult
    func getLastEpisode<T: CustomStringConvertible>(
        showID id: T,
        extended: [ExtendedType] = [.Min],
        completion: @escaping ObjectCompletionHandler<TraktEpisode>
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "shows/\(id)/last_episode",
            withQuery: ["extended": extended.queryString()],
            isAuthorized: false,
            withHTTPMethod: .GET
        ) else { return nil }
