...
public extension TraktManager {
     ...
     */
    @discardableResult
    func lastActivities(completion: @escaping LastActivitiesCompletionHandler) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "sync/last_activities",
            withQuery: [:],
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func getPlaybackProgress(
        type: WatchedType,
        timeRange: Int? = nil,
        completion: @escaping ObjectsCompletionHandler<PlaybackProgress>
    ) -> URLSessionDataTaskProtocol? {
        var query: [String: String] = [:]
        if let days = timeRange, days > 0 {
            let dateFormatter = ISO8601DateFormatter()
            dateFormatter.formatOptions = [.withInternetDateTime, .withFractionalSeconds]

            let endAt = Date() // 当前日期时间
            var startAt: Date?

            startAt = endAt.addingTimeInterval(TimeInterval(-days * 24 * 60 * 60))

            if let startAt = startAt {
                query = [
                    "start_at": dateFormatter.string(from: startAt),
                    "end_at": dateFormatter.string(from: endAt),
                ]
            }
        }
        guard let request = mutableRequest(
            forPath: "sync/playback/\(type)",
            withQuery: query,
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
     ...
     */
    @discardableResult
    func removePlaybackItem<T: CustomStringConvertible>(
        id: T,
        completion: @escaping SuccessCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "sync/playback/\(id)",
            withQuery: [:],
            isAuthorized: true,
    ...
    func getCollection(
        ...
        completion: @escaping CollectionCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "sync/collection/\(type)",
    ...
    func addToCollection(
        movies: [CollectionId]? = nil,
        shows: [CollectionId]? = nil,
        seasons: [CollectionId]? = nil,
        episodes: [CollectionId]? = nil,
        completion: @escaping ObjectCompletionHandler<AddToCollectionResult>
    ...
    func removeFromCollection(
        ...
        seasons: [SyncId]? = nil,
        episodes: [SyncId]? = nil,
        completion: @escaping ObjectCompletionHandler<RemoveFromCollectionResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
    ...
    func getWatchedShows(
        extended: [ExtendedType] = [.Min],
        completion: @escaping WatchedShowsCompletionHandler
    ) -> URLSessionDataTaskProtocol? {

        guard let request = mutableRequest(
            forPath: "sync/watched/shows",
            withQuery: ["extended": extended.queryString()],
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func getWatchedMovies(
        extended: [ExtendedType] = [.Min],
        completion: @escaping WatchedMoviesCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        guard let request = mutableRequest(
            forPath: "sync/watched/movies",
            withQuery: ["extended": extended.queryString()],
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    @discardableResult
    func addToHistory(
        movies: [TraktPostDataV2]? = nil,
        shows: [TraktPostDataV2]? = nil,
        seasons: [TraktPostDataV2]? = nil,
        episodes: [TraktPostDataV2]? = nil,
        completion: @escaping ObjectCompletionHandler<AddToHistoryResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
    ...
    func removeFromHistory(
        ...
        episodes: [TraktPostDataV2]? = nil,
        historyIDs: [Int]? = nil,
        completion: @escaping ObjectCompletionHandler<RemoveFromHistoryResult>
    ) throws -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func getRatings(type: WatchedType, rating: NSInteger?, completion: @escaping RatingsCompletionHandler) -> URLSessionDataTaskProtocol? {
    ...
    @discardableResult
    func addRatings(
        movies: [EpisodeRatingsData]? = nil,
        shows: [EpisodeRatingsData]? = nil,
        seasons: [EpisodeRatingsData]? = nil,
        episodes: [EpisodeRatingsData]? = nil,
        completion: @escaping ObjectCompletionHandler<AddRatingsResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
    ...
    func removeRatings(
        ...
        seasons: [SyncId]? = nil,
        episodes: [SyncId]? = nil,
        completion: @escaping ObjectCompletionHandler<RemoveRatingsResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
    ...
    @discardableResult
    func getWatchlist(
        watchType: WatchedType,
        pagination: Pagination? = nil,
        extended: [ExtendedType] = [.Min],
        completion: @escaping WatchlistCompletionHandler
    ) -> URLSessionDataTaskProtocol? {
        ...
        guard let request = mutableRequest(
            forPath: "sync/watchlist/\(watchType.rawValue)",
            withQuery: query,
            isAuthorized: true,
            withHTTPMethod: .GET
        ) else { return nil }
    ...
    func addToWatchlist(
        ...
        seasons: [TraktPostDataV2]? = nil,
        episodes: [TraktPostDataV2]? = nil,
        completion: @escaping ObjectCompletionHandler<WatchlistItemPostResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
        guard let request = post("sync/watchlist", body: body) else { completion(.error(error: nil))
            return nil
        }
        return performRequest(request: request, completion: completion)
    }
    ...
    func removeFromWatchlist(
        ...
        seasons: [TraktPostDataV2]? = nil,
        episodes: [TraktPostDataV2]? = nil,
        completion: @escaping ObjectCompletionHandler<RemoveFromWatchlistResult>
    ) throws -> URLSessionDataTaskProtocol? {
        let body = TraktMediaBody(movies: movies, shows: shows, seasons: seasons, episodes: episodes)
        guard let request = post("sync/watchlist/remove", body: body) else { completion(.error(error: nil))
            return nil
        }
        return performRequest(request: request, completion: completion)
    }
    ...
    func addToFavorite(
        ...
        let body = TraktMediaBody(movies: movies, shows: shows)
        guard let request = post("sync/favorites", body: body) else { completion(.error(error: nil))
            return nil
        }
        return performRequest(request: request, completion: completion)
    }
    ...
    func removeFromFavorite(
        ...
        let body = TraktMediaBody(movies: movies, shows: shows)
        guard let request = post("sync/favorites/remove", body: body) else { completion(.error(error: nil))
            return nil
        }
        return performRequest(request: request, completion: completion)
    }
